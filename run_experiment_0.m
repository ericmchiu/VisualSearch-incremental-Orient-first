...
text(0.05,.9,'You are about to start an experiment block.','Fontsize', 60)
text(0.1,.775,'INSTRUCTIONS: (please read carefully)','Fontsize',40)
text(0.1,.6,'The color of the Horizontal and Vertical bars identify the color of the target.','Fontsize', 30)
text(0.1,.65,'Grey Horizontal bars that appear on the top and bottom of the screen identify a horizontal target.','Fontsize', 30)
text(0.1,.7,'Grey Vertical bars that appear on the left and right of the screen identify a vertical target.','Fontsize', 30)
...
text(0.05,.1,'Notify the experimenter when this experiment block ends.','Fontsize', 50)
tic